...
metadata:
  tags: todo, planning, documentation, verification, sub-agents
---
...
4. Document inside the `TODO_LIST.md` which files you already read and which you know you still need to READ!
