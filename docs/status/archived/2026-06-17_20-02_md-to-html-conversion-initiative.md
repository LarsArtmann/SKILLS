...
| - | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ------ | ---------- |
| ~~1~~ | ~~Extract shared assets/report.html + html-output-guide.md~~ done — html-report-kit skill created (2026-06-17) with vendoring model | 🔴 High | 30min  | ⭐⭐⭐⭐⭐ |

### The 4% → 64% (highest-leverage conversions + the consolidation)

| # | Task                                                                                                    | Impact  | Effort | Ratio      |
| - | ------------------------------------------------------------------------------------------------------- | ------- | ------ | ---------- |
| ~~2~~ | ~~Convert status-report → HTML~~ done — HTML dashboards are its canonical output                                           | 🔴 High | 20min  | ⭐⭐⭐⭐⭐ |
| ~~3~~ | ~~Convert pareto-planning → HTML + D2~~ done — D2 graphs + `allowed-tools: d2`                          | 🔴 High | 25min  | ⭐⭐⭐⭐⭐ |
| ~~4~~ | ~~Consolidate full-code-review → pareto delegation~~ done | 🔴 High | 20min  | ⭐⭐⭐⭐⭐ |
| ~~5~~ | ~~Convert go-modularize outputs → HTML~~ done — go-modularize is an html-report-kit consumer  | 🟡 Med  | 30min  | ⭐⭐⭐⭐   |

### The 20% → 80% (Tier 2 conversions)

| # | Task                                                                                    | Impact | Effort | Ratio    |
| - | --------------------------------------------------------------------------------------- | ------ | ------ | -------- |
| ~~6~~ | ~~Convert code-quality-scan → HTML~~ done — consumer; HTML issue dashboard | 🟡 Med | 25min  | ⭐⭐⭐⭐ |
| ~~7~~ | ~~Convert naming-review report → HTML~~ done — consumer                         | 🟡 Med | 25min  | ⭐⭐⭐   |
| ~~8~~ | ~~Convert nix-flake-migration → HTML~~ done — consolidated into html-report-kit              | 🟡 Med | 20min  | ⭐⭐⭐   |
| ~~9~~ | ~~Convert brutal-self-review plan → HTML~~ done — consumer                                    | 🟢 Low | 20min  | ⭐⭐     |

### Polish (the long tail)

| #  | Task                                                                         | Impact | Effort | Ratio    |
| -- | ---------------------------------------------------------------------------- | ------ | ------ | -------- |
| ~~10~~ | ~~Encode the Artifact decision rule~~ done — the Artifact rule lives in the guide (AGENTS §5.9) | 🟡 Med | 15min  | ⭐⭐⭐⭐ |
| ~~11~~ | ~~Add allowed-tools~~ done — AGENTS §5.8            | 🟢 Low | 10min  | ⭐⭐⭐   |
| ~~12~~ | ~~Add cross-references~~ done — consumers reference the vendored kit                 | 🟢 Low | 10min  | ⭐⭐     |
| ~~13~~ | ~~Update AGENTS.md §5~~ done — §5.9              | 🟢 Low | 10min  | ⭐⭐     |
| ~~14~~ | ~~Update README.md~~ done — kit documented with vendoring note                   | 🟢 Low | 5min   | ⭐⭐     |
...
(e.g. `html-report-kit/`) or as a shared `assets/` directory?~~** RESOLVED — standalone skill directory `html-report-kit/`, vendored into consumers (AGENTS §5.9).
