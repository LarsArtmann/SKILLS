...
**Standing notes:** Auto-commit daemon owns commits (correct). ~~Unprocessed feedback (`docs/feedback/new/2026-09-11_*`) remains unowned by any skill~~ _(processed 2026-09-13 at `0f70bdb` — all four incidents encoded, file archived to processed/)_ — its four incidents map to verify-external-claims, shell-tooling, quality-gate, and editing skills respectively; routing it is docs-health work, listed here only so it is not forgotten.
