...
| ~~2~~  | ~~Write CHANGELOG.md wave entry for today (skill + check-skills fixes + evals)~~ done — dated linter-building wave entry backfilled into CHANGELOG 2026-09-18                                               | ~~Medium~~ | ~~S~~  | ~~Documentation~~ |
...
| ~~8~~  | ~~Re-word round-2 report's "zero unverified claims" line via non-destructive annotation~~ done (docs-health pass 2026-09-18 — the round-2 "zero unverified claims" line corrected inline in 20-08)          | ~~Medium~~ | ~~S~~  | ~~Documentation~~ |
| ~~9~~  | ~~Answer g1-g3 (T34) — unblocks reference scope, aging, commit ownership~~ done — routed to TODO_LIST T34 (BLOCKED)                                                                                         | ~~High~~   | ~~S~~  | ~~Decision~~      |
| ~~10~~ | ~~Execute T35: sweep docs/status for pre-fix green check-skills claims, annotate~~ done (docs-health pass 2026-09-18 — T35 executed by this pass)                                                           | ~~Low~~    | ~~M~~  | ~~Documentation~~ |
...
| ~~16~~ | ~~Encode or reject status-report `.md`-for-this-repo precedent (3rd occurrence)~~ done — routed to ROADMAP Open Questions — 8th recurrence logged 2026-09-18                                                | ~~Low~~    | ~~S~~  | ~~Documentation~~ |
