...
| T34 | linter-building open questions from the 20-08 self-review: Go-first vs multi-language depth (g1), synthetic-eval aging vs wait-for-real-trigger (g2), commit-ownership convention (g3) — user decisions needed                                                                                                                                  | 🔵 BLOCKED | Medium | S      | `docs/status/2026-09-09_20-08_linter-building-session-self-review.md` g1-g3; eval iteration-1 already ran (`linter-building/evals/`)                                                              |
| T35 | Annotate remaining status reports that predate the check-skills.sh zero-count fix (script silently exited 1 from heuristic commit `3f3aa37` until 2026-09-09 fix): sweep `docs/status/` for green check-skills claims, append ANNOTATE appendices                                                                                               | 🔴 TODO    | Low    | M      | `docs/status/2026-09-09_20-08_*` d1/f13; wave-3 03-58 report already annotated                                                                                                                    |
