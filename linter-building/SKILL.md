...
| Claim                                                                                                                                                                                                                                                            | Status                              | Source                                                                                                                                                                     |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| go-finding public (v1.12.x core, re-checked 2026-09-17: all 5 modules test green, API unchanged): `Finding` struct, `NewBuilder(...).Build()`, `Detector` interface shapes                                                                                       | ✅ verified 2026-09-17, source read | `/home/lars/projects/go-finding/{finding,finding_builder,detector}.go`                                                                                                     |
